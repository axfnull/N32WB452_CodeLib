...
3、使用说明
    系统配置；
        ...
        3、端口配置：
            ...
            PD15选择为外部EXTI事件上升沿触发
        4、DMA：
            DMA1_CH1通道循环模式搬运64个半字的ADC1规则通道转换结果到ADC_RegularConvertedValueTab[64]数组
        5、ADC：
    ...
    使用方法：
        ...
        2、通过PE11给上升沿可以触发规则通道数据采样，PD15给上升沿可以触发注入通道数据采样
4、注意事项
...
3. Instructions for use
    System configuration;
        ...
        3. Port Configuration:
            ...
            PD15 is selected as an external EXTI event rising edge trigger
        4, DMA:
    ...
    Instructions:
        ...
        2. Regular channel data sampling can be triggered by PE11 rising edge, and injection channel data sampling can be triggered by PD15 rising edge
