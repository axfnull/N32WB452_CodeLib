...
3. 使用说明
    ...
    描述Demo的测试步骤和现象 
         1. 编译后下载程序复位运行；
         2. 通过 USB 线连接 J4 USB 口，USB 挂载完成后，识别成 U 盘设备
...
3. Instructions for use
    ...
    Describe the test steps and phenomena of Demo 
        ...
        2. Connect the J4 USB port through a USB cable, and after the USB is mounted, it will be recognized as a U disk device.
