...
3. 使用说明
    ...
    描述Demo的测试步骤和现象 
         1. 编译后下载程序复位运行；
         2. 通过 USB 线连接 J4 USB 口，USB 挂载完成后，在电脑设备管理中可以看到新增的串口，将 USART1 接到串口工具上，打开 USB 虚拟串口，USB 虚拟串口发送数据，用串口工具接收数据，然后用串口工具发送数据， USB 虚拟串口接收数据
...
3. Instructions for use
    ...
    Describe the test steps and phenomena of Demo 
        ...
        2. Connect the USB cable to the J4 USB port. After the USB is mounted, the newly added serial port can be seen in computer device management. 
