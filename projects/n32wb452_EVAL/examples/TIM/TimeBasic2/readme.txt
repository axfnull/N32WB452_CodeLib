...
3. Instructions for use
     System Configuration;
         1. Clock source:
             HSE=8M, PLL=144M, AHB=144M, APB1=36M, APB2=72M, TIM2 CLK=72M
         2. Interruption:
             TIM2 update interrupt is turned on, steal priority level 0, sub priority level 1
     ...
     Instructions:
         ...
         2. After the program runs, the periodic interrupt of TIM2 comes to flip the PC6 level
