...
3. 使用说明
    ...
    描述Demo的测试步骤和现象 
         1. 编译后下载程序复位运行
         2. 通过 USB 线连接 J4 USB 口，USB 挂载完成后，在电脑设备管理中可以看到新增的串口，打开 USB 虚拟串口，可以看到串口一直接收到数据，虚拟串口也可以发送数据，发送的数据可以通过日志串口进行打印输出
...
3. Instructions for use
    ...
    Describe the test steps and phenomena of Demo 
        ...
        2. Connect the USB cable to the J4 USB port. After the USB is mounted, you can see the new serial port in computer device management. 
