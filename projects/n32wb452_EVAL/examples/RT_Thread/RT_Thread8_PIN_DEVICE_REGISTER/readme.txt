...
3. 使用说明
    ...
    描述Demo的测试步骤和现象 
         1. 编译后下载程序复位运行
         2. 本例程创建三个线程，led0 线程、led1 线程 key 线程，led0 线程用于控制 D1 500ms闪烁，led1 线程用于控制 D10 250ms闪烁，
            key 线程检测 KEY0、KEY1和KEYUP，其中KEYUP开启中断功能，当KEYUP按下时，调用中断回调函数，有按键按下时打印相应日志
