1、功能说明
    ...
    该测例演示了USARTy与USARTz间串行IrDA红外解码功能的基础通信。
...
1. Function description
    ...
    This test example demonstrates the basic communication of the serial IrDA infrared decoding function between USARTy and USARTz.
...
2. Use environment
    ...
    Software development environment: KEIL MDK-ARM Professional Version 5.26.2.0
        ...
        Hardware environment: development board N32G457QEL_EVB_V1.1
